    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
           ...
           if (cont == false)
            ...
            Console.WriteLine();
            Console.Write("Would you like to see the current list of activities? Type 'true' for 'yes'/'false' for 'no': ");
            ...
            if (seeList)
            {
                ...
                Console.WriteLine();
                Console.Write("Would you like to add any activities before we generate one? Type 'true' for 'yes'/'false' for 'no': ");
                ...
                while (addToList)
                {
                    ...
                    Console.WriteLine();
                    Console.WriteLine("Would you like to add more?Type 'true' for 'yes'/'false' for 'no': ");
